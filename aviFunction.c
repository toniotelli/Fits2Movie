...
void allocFrames(AVStream *st, AVFrame **frameRGB, AVFrame **frameYUV, uint8_t *buffRGB, uint8_t *buffYUV){
	int sB1,sB2;
    
	// RGB Frame
	*frameRGB=av_frame_alloc();
	(*frameRGB)->width=st->codec->width;
	(*frameRGB)->height=st->codec->height;
